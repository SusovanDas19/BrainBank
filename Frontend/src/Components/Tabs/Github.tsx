  ...
  useEffect(() => {
    ...
    const getData = async () => {
      try {
        ...
        const url =
          `https://api.brainbank.cv/v1/content/fetch?type=Github` +
    ...
    <div className="h-screen flex flex-col bg-white dark:bg-primaryBlack">
      {loading ? (
        ...
        <div className="flex-1 overflow-y-auto pt-46 p-4 top-30 pb-10 ml-10 mr-10">
          <div className="grid grids-cols-1 md:grid-cols-4 gap-10 w-full justify-center items-center mt-10">
